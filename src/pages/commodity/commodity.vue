...
const result = [
  ...
  //口红管系列 耳机
  {
    ...
    name: "口红管系列 耳机",
    subtitle:
      "口红管系列，精致如口红般小巧，轻松放入口袋或化妆包。优雅开合间，完成耳机充电的时尚仪式——让科技如口红般装点生活。",
    describe:
      "口红管系列以口红为灵感，打造掌心大小的精致充电仓。皮质质感机身，推出闪耀金/月光银/樱花粉三款潮流配色，轻松搭配日常穿搭。支持15分钟快充续航3小时，LED灯条实时显示电量，开盖即连超便捷。重量仅35g，随身放入化妆包无负担，随放随充不断电。",
    price: 3980,
    StyleGuide: "穿戴式",
    tax: true, //true-含税，false-不含税
    serialNumber: "A09-2",
  ...
  //耳机仓系列 银
  {
    ...
    name: "耳机仓系列 银",
    subtitle:
      "耳机仓系列珠宝仓款式，科技与奢华的完美融合，将珠宝耳机升华为耳尖艺术品，采用18K金镀层与天然宝石镶嵌工艺，打造可佩戴的时尚配饰。",
    describe:
      "聆听，亦是一场奢华盛宴。以高级珠宝工艺重新定义耳机，18K金镀层搭配天然钻石/宝石镶嵌，化作可佩戴的耳尖艺术品。梵克雅宝同厂匠人手工打造，支持磁吸快充，开合间流光溢彩。每件配备专属珠宝证书与真皮礼盒，更提供私人刻字定制服务。三大高定系列星河/极光/暮色，让科技产品升华为传世藏品。",
    price: 3980,
    StyleGuide: "入耳式",
    tax: true, //true-含税，false-不含税
    serialNumber: "A09-2",
  ...
  //耳机仓系列 彩色
  {
    ...
    name: "耳机仓系列 彩色",
    subtitle:
      "透明仓款式简约实用主义采用高强度环保ABS材质，重量仅28g，轻松放入口袋无负担。磨砂防滑表面处理，抗摔耐磨经久耐用。",
    describe:
      "透明仓款式采用环保ABS材质打造，简约不简单的实用主义。28g超轻机身配合磨砂质感，防滑耐摔更便携。Type-C快充技术，充电10分钟畅听2小时，磁吸开合设计实现开盖秒连。通过2000次耐久测试，以亲民价格诠释实用美学。",
    price: 3980,
    StyleGuide: "入耳式",
    tax: true, //true-含税，false-不含税
    serialNumber: "A09-2",
